...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="Server">
    <div class="container">
        <div class="ColContent">
                ...
                <asp:ListView ID="lstProductSale" runat="server" OnItemCommand="lstProductSale_ItemCommand"
                    ...
                    <ItemTemplate>
                        <div class="item">
                            ...
                            <%# Eval("IsNew").ToString() == "True" ? "<div class='icon-new'><img src='assets/images/icon-new.png' alt='' /></div>" : "" %>
                        </div>
                    </ItemTemplate>
                    <LayoutTemplate>
            ...
            <div class="pager">
                <asp:DataPager ID="DataPager1" runat="server" PageSize="16" PagedControlID="lstProductSale">
                    <Fields>
