        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"  DataSourceID="ObjectDataSource1"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Giới tính" DataField="Gender" SortExpression="Gender">
                        <ItemTemplate>
                            <asp:Label ID="lblGender" runat="server" Text='<%# Eval("Gender").ToString() == "0" ? "Nữ" :  Eval("Gender").ToString() == "1" ? "Nam" : "Không khai báo" %>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Birthday" DataField="Birthday" SortExpression="Birthday">
                        <ItemTemplate>
